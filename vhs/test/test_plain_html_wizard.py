...
@skip(
    reason="This test is currently failing due to a change in the expected ffmpeg command arguments. Needs investigation and update when we have more tokens"
)
