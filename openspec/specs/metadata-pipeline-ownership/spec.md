## Purpose
Define explicit ownership boundaries across the metadata pipeline and the deterministic resolver contract for effective page and crop metadata before XMP serialization.
