## Purpose
Define the contract for LM Studio caption matching — assigning captions to detected photo regions by sending the album page image to a configured vision model and merging the response with Docling bounding boxes.
