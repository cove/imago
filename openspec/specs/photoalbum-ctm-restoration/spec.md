...
Imago MUST support generating a 3x3 chromatic-restoration Color Transformation Matrix (CTM) for a stitched photoalbum image using a configured Gemma 4 model served through LM Studio.
...
- **AND** requests structured output containing a 3x3 CTM
...
- **THEN** Imago applies the 3x3 transform after stitching completes
